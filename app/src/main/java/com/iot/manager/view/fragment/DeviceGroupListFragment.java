...
import com.iot.manager.presenter.FG_GroupDeviceListPresenter;
 ...
 */
public class DeviceGroupListFragment extends BaseMVPFragment<DeviceGroupListContract.View, FG_GroupDeviceListPresenter> implements DeviceGroupListContract.View ,View.OnClickListener{

    public static DeviceGroupListFragment newInstance(ArrayList<Deviceslist> childs) {
        Bundle args = new Bundle();
        args.putSerializable(OLDDATAKEY,childs);
        DeviceGroupListFragment fragment = new DeviceGroupListFragment();
        fragment.setArguments(args);
        return fragment;
    }
    public static DeviceGroupListFragment newInstance(Deviceslist childs) {
        Bundle args = new Bundle();
        args.putSerializable(OLDDATAKEY,childs);
        DeviceGroupListFragment fragment = new DeviceGroupListFragment();
        fragment.setArguments(args);
    ...
    public DeviceGroupListFragment setaItem(boolean aItem) {
        this.aItem = aItem;
        return this;
    }
    @Override
