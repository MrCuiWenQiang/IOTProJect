...
import com.iot.manager.presenter.FG_CMPresenter;
import com.iot.manager.view.ContentManagerActivity;
import com.iot.manager.view.adapter.ContorlAdapter;
 ...
 */
public class ControlManagerFragment extends BaseMVPFragment<Fg_CMContract.View,FG_CMPresenter> implements Fg_CMContract.View {

    public static ControlManagerFragment newInstance() {
        Bundle args = new Bundle();
        ControlManagerFragment fragment = new ControlManagerFragment();
    ...
    private ContorlAdapter adapter = new ContorlAdapter();

    public  int  page =1 ;

    @Override
    public int getLayoutId() {
        return R.layout.fg_cmlist;
    }
    ...
    protected void initListener() {
        ...
        adapter.setOnItemCheckedListener(new ContorlAdapter.OnItemCheckedListener() {
            @Override
            public void onChecked(int position, ControlEntity b) {
                Intent intent = new Intent(getContext(), ContentManagerActivity.class);
                intent.putExtra(ContentManagerActivity.KEY,b.getId());
    ...
    @Override
    public void getList_Success(List<ControlEntity> datas) {
        end();
