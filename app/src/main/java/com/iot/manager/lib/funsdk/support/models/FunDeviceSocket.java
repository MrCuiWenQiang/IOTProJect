package com.iot.manager.lib.funsdk.support.models;

import com.iot.manager.lib.funsdk.support.config.BaseConfig;
import com.iot.manager.lib.funsdk.support.config.OPPowerSocketGet;
import com.iot.manager.lib.funsdk.support.config.PowerSocketArm;
import com.iot.manager.lib.funsdk.support.config.PowerSocketAutoLight;
import com.iot.manager.lib.funsdk.support.config.PowerSocketAutoSwitch;
import com.iot.manager.lib.funsdk.support.config.PowerSocketAutoUsb;
import com.iot.manager.lib.funsdk.support.config.PowerSocketBanLed;
import com.iot.manager.lib.funsdk.support.config.PowerSocketDelayLight;
import com.iot.manager.lib.funsdk.support.config.PowerSocketDelaySwitch;
import com.iot.manager.lib.funsdk.support.config.PowerSocketDelayUsbPower;
import com.iot.manager.lib.funsdk.support.config.PowerSocketImage;
import com.iot.manager.lib.funsdk.support.config.PowerSocketSensitive;
import com.iot.manager.lib.funsdk.support.config.PowerSocketWorkRecord;
