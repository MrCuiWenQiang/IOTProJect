...
//		}
	...
	public static String getCatureBasePath(){
		return FunPath.PATH_CAPTURE_TEMP + File.separator;
	}
	public static String getRecordBasePath(){
		  return FunPath.PATH_VIDEO + File.separator ;
	}
