...
import com.iot.manager.entity.net.result.DeviceInfoEntity;
 ...
 */
public class FG_DeviceManagerPresenter extends BaseMVPPresenter<DeviceManagerContract.View> implements DeviceManagerContract.Presenter {
    ...
    public void getRelayData(int page,final String type) {
        ...
        HttpHelper.get(URLs.DEVICEGETPAGEDATA, hashMap, new HttpResponseCallback() {
            @Override
    ...
    @Override
    public void removeName(String id, String name) {

        DeviceInfoEntity entity = new DeviceInfoEntity();
        entity.setName(name);
        entity.setId(id);
        HttpHelper.post(URLs.DEVICEMODIFY, entity, new HttpResponseCallback() {
            @Override
            public void onSuccess(String data) {
            ...
            public void onMessage(String msg) {
                super.onMessage(msg);
                if (getView()!=null){
                    getView().removeName_success(msg);
                }
            }
            ...
            public void onFailed(int status, String message) {
                if (getView()!=null){
                    getView().removeName_fail(message);
                }
            }
        });
    }
